...
Level 1
Create a console app that have classes and objects. For example like below with computers and phones. Laptop Computers
- MacBook
- Asus
- Lenovo Mobile Phones - Iphone
- Samsung - Nokia
...
using AssetTrackingWeek30;

public class Program
{
    public static void Main(string[] args)
    {
        AssetTracking assetTrackingApp = new AssetTracking();
        assetTrackingApp.Run();
    }
}
